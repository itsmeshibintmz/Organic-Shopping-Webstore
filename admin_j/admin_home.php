...
<html>
<head>
<title>Dreams|Admin Home Page</title>
<!-- for-mobile-apps -->
					...
					<ul class="slides">
						<li>
							<div class="w3l_banner_nav_right_banner">
								<h3>Welcome <span>to Dreams</span> admin application</h3>
								
							</div>
						</li>
						<li>
							<div class="w3l_banner_nav_right_banner1">
								<h3>Manage<span>your</span>business</h3>
								
							</div>
						</li>
						<li>
							<div class="w3l_banner_nav_right_banner2">
								<h3>Dreams <i>a complete business application</i> </h3>
