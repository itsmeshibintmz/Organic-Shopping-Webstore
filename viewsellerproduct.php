		  ...
		  <form action="viewproduct.php" method="POST" name="prod" id="prod">
			<div class="content_box">
			   	<div class="left-grid-view grid-view-left">
				    ...
				    <p> Rs.<?php   echo $rowp['price'] ?></p>
				 Quntity <?php   echo $rowp['qunty'] ?>
				 
				 <input type="text" name="prod_id" id="prod_id" value="<?php   echo $rowp['pid'] ?>" hidden>
				 <br>
				<br>
				<br>
				<!-- <a href="delete_seller_prod.php?pid=<?php echo $rowp['pid'];?>&action=edit" background="#FF5733 "; style="color:red;" ><b>Edit</b></a>   
<a href="delete_seller_prod.php?pid=<?php echo $rowp['pid'];?>&action=delete" background="green";  onclick="return (confirm('Are You Sure To Delete The Record?'));" style="color:red;" ><b>Delete </b></a>-->
	...
	<div class="sub-cate">
		...
		<li class="item2" class="menu"><a href="#">Profile<img class="arrow-img " src="images/arrow1.png" alt=""/></a>
			<ul class="cute">
