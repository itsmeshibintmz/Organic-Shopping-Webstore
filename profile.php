...
<body> 
	...
	<div class="container">
			...
			?>
				...
				<label>First Name :&nbsp &nbsp  &nbsp<?php echo $fname; ?></span>
			
			</br>
			</br>
			<label>Last Name  &nbsp &nbsp  :&nbsp <?php echo $lname; ?></span>
			</br>
			</br>
			<label>Mobile No  &nbsp &nbsp  &nbsp :  <?php echo $ph; ?></span>
			</br>
			</br>
			<label>Email ID &nbsp &nbsp  :&nbsp <?php echo $_SESSION['alogin']; ?></label>
			</br>
			</br>
			   </div>	
			   <div>
