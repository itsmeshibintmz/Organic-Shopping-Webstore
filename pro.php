...
$newprodname=$_POST["prod_cat_name"];
$prod_cat_name=$_POST["prod_cat"];


						$getid=mysqli_query($con,"SELECT product_category_id FROM tbl_product_category  wHERE prod_category_name= '$prod_cat_name' ");
...
<p style="color:red">Add new product category</p>
</br>
		...
		<form action="addcat.php" method="POST" name="add_new_prod_cat" id="add_new_prod_cat">
			...
			<input type="text" name="prod_new_cat_name" id="prod_new_cat_name" onblur="checkNewProdCat()" placeholder="new category name" value="" required>
					...
					<script>
							...
							function checkNewProdCat()
									...
									var fnamevalue=document.getElementById("prod_new_cat_name").value;
									//document.getElementById('errorname').innerHTML=fnamevalue;
									
									if (fnamevalue==null || add_new_prod_cat.prod_new_cat_name.value.length==0)
									{
									document.getElementById('nerrorname').innerHTML="Mandatory Field!";
	
									}
									else if(add_new_prod_cat.prod_new_cat_name.value.match(letters))
									{
									...
									document.getElementById('prod_new_cat_name').value = ""; 
									add_new_prod_cat.prod_new_cat_name.value ="";
									}
					...
					<select name="statuspn" id="statuspn">
					...
					<input type="submit" name="newprod_cat_s" id="newprod_cat_s" value="Add product category">
...
$newprodstat=$_POST["statuspn"];
$prod_new_cat_name=$_POST["prod_new_cat_name"];
$flag=0;

$prodc="";
$checknamep="Select * from tbl_product_category WHERE prod_category_name='$prod_new_cat_name'";
...
if((strcmp($prodc,$prod_new_cat_name) == 0))
  	{	
		$flag=$flag+1;
...
{
	$q_ins="INSERT INTO tbl_product_category (prod_category_name,status) VALUES('$prod_new_cat_name','$newprodstat')";
